...
## Environments
- Preview: https://main--test-acarol--aemysites.aem.page/
- Live: https://main--test-acarol--aemysites.aem.live/
- Block Library: https://main--test-acarol--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `test-acarol` directory in your favorite IDE and start coding :)
